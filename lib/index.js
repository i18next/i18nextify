...
var _i18nextLib = require('i18next/lib');

var _i18nextLib2 = _interopRequireDefault(_i18nextLib);

var _i18nextXhrBackendLib = require('i18next-xhr-backend/lib');

var _i18nextXhrBackendLib2 = _interopRequireDefault(_i18nextXhrBackendLib);

var _i18nextBrowserLanguagedetectorLib = require('i18next-browser-languagedetector/lib');

var _i18nextBrowserLanguagedetectorLib2 = _interopRequireDefault(_i18nextBrowserLanguagedetectorLib);
...
_i18nextLib2['default'].use(_i18nextXhrBackendLib2['default']);
_i18nextLib2['default'].use(_i18nextBrowserLanguagedetectorLib2['default']);

// log out missings
_i18nextLib2['default'].on('missingKey', _missingHandler.missingHandler);
...
function init() {
  ...
  _i18nextLib2['default'].init(options, done);
